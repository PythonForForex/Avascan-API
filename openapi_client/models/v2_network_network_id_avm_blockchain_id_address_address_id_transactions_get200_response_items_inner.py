...
class V2NetworkNetworkIdAvmBlockchainIdAddressAddressIdTransactionsGet200ResponseItemsInner(BaseModel):
    """
    ...
    inputs: List[V2NetworkNetworkIdAvmBlockchainIdAddressAddressIdTransactionsGet200ResponseItemsInnerInputsInner]
    outputs: List[V2NetworkNetworkIdAvmBlockchainIdAddressAddressIdTransactionsGet200ResponseItemsInnerInputsInner]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('base', 'create_asset', 'create_asset_fixed_cap', 'create_asset_var_cap', 'create_asset_nft', 'operation', 'mint_asset_var_cap', 'mint_nft', 'transfer_nft', 'multimint_var_cap', 'multimint_nft', 'multitransfer_nft', 'composite', 'import', 'export'):
            raise ValueError("must be one of enum values ('base', 'create_asset', 'create_asset_fixed_cap', 'create_asset_var_cap', 'create_asset_nft', 'operation', 'mint_asset_var_cap', 'mint_nft', 'transfer_nft', 'multimint_var_cap', 'multimint_nft', 'multitransfer_nft', 'composite', 'import', 'export')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "inputs": [V2NetworkNetworkIdAvmBlockchainIdAddressAddressIdTransactionsGet200ResponseItemsInnerInputsInner.from_dict(_item) for _item in obj.get("inputs")] if obj.get("inputs") is not None else None,
            "outputs": [V2NetworkNetworkIdAvmBlockchainIdAddressAddressIdTransactionsGet200ResponseItemsInnerInputsInner.from_dict(_item) for _item in obj.get("outputs")] if obj.get("outputs") is not None else None,
            "memo": obj.get("memo")
        })
        return _obj
