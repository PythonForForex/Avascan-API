...
class V2NetworkNetworkIdPvmBlockchainIdAddressAddressIdTransactionsGet200Response(BaseModel):
    """
    V2NetworkNetworkIdPvmBlockchainIdAddressAddressIdTransactionsGet200Response
    """ # noqa: E501
    items: List[V2NetworkNetworkIdPvmBlockchainIdAddressAddressIdTransactionsGet200ResponseItemsInner]
    link: V2NetworkNetworkIdEvmCrossTransactionsGet200ResponseLink
    __properties: ClassVar[List[str]] = ["items", "link"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "items": [V2NetworkNetworkIdPvmBlockchainIdAddressAddressIdTransactionsGet200ResponseItemsInner.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
