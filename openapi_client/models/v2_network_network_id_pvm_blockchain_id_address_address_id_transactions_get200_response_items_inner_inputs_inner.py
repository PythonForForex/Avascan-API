...
class V2NetworkNetworkIdPvmBlockchainIdAddressAddressIdTransactionsGet200ResponseItemsInnerInputsInner(BaseModel):
    """
    ...
    amount: StrictStr
    owner: Optional[V2NetworkNetworkIdPvmBlockchainIdAddressAddressIdTransactionsGet200ResponseItemsInnerInputsInnerOwner] = None
    creds: List[V2NetworkNetworkIdAvmBlockchainIdAddressAddressIdTransactionsGet200ResponseItemsInnerInputsInnerCredsInner]
    ...
    __properties: ClassVar[List[str]] = ["id", "txId", "index", "amount", "owner", "creds", "srcChain", "asset"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "owner": V2NetworkNetworkIdPvmBlockchainIdAddressAddressIdTransactionsGet200ResponseItemsInnerInputsInnerOwner.from_dict(obj.get("owner")) if obj.get("owner") is not None else None,
