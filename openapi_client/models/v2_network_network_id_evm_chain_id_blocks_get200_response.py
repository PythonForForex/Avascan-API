...
class V2NetworkNetworkIdEvmChainIdBlocksGet200Response(BaseModel):
    """
    V2NetworkNetworkIdEvmChainIdBlocksGet200Response
    """ # noqa: E501
    items: List[V2NetworkNetworkIdEvmChainIdBlocksGet200ResponseItemsInner]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "items": [V2NetworkNetworkIdEvmChainIdBlocksGet200ResponseItemsInner.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "count": obj.get("count"),
