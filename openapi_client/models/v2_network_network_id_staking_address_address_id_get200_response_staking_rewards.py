...
class V2NetworkNetworkIdStakingAddressAddressIdGet200ResponseStakingRewards(BaseModel):
    """
    V2NetworkNetworkIdStakingAddressAddressIdGet200ResponseStakingRewards
    """ # noqa: E501
    value: StrictStr
