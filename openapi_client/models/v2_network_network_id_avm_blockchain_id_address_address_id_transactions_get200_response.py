...
class V2NetworkNetworkIdAvmBlockchainIdAddressAddressIdTransactionsGet200Response(BaseModel):
    """
    V2NetworkNetworkIdAvmBlockchainIdAddressAddressIdTransactionsGet200Response
    """ # noqa: E501
    items: List[V2NetworkNetworkIdAvmBlockchainIdAddressAddressIdTransactionsGet200ResponseItemsInner]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "items": [V2NetworkNetworkIdAvmBlockchainIdAddressAddressIdTransactionsGet200ResponseItemsInner.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
