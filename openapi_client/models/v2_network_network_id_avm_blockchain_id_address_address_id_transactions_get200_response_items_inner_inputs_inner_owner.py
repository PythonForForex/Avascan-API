...
class V2NetworkNetworkIdAvmBlockchainIdAddressAddressIdTransactionsGet200ResponseItemsInnerInputsInnerOwner(BaseModel):
    """
    V2NetworkNetworkIdAvmBlockchainIdAddressAddressIdTransactionsGet200ResponseItemsInnerInputsInnerOwner
    """ # noqa: E501
    addresses: List[StrictStr]
    threshold: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["addresses", "threshold"]
