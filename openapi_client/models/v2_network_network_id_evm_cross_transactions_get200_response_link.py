...
class V2NetworkNetworkIdEvmCrossTransactionsGet200ResponseLink(BaseModel):
    """
    V2NetworkNetworkIdEvmCrossTransactionsGet200ResponseLink
    """ # noqa: E501
    next: Optional[StrictStr] = None
    next_token: Optional[StrictStr] = Field(default=None, alias="nextToken")
    __properties: ClassVar[List[str]] = ["next", "nextToken"]
